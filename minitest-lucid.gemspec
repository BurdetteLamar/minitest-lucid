...
require 'minitest/lucid/version'

Gem::Specification.new do |spec|
  spec.name          = 'minitest-lucid'
  spec.version       = Minitest::Lucid::VERSION
  ...
  spec.homepage      = 'https://www.github.com/BurdetteLamar/minitest-lucid'
  spec.license       = 'MIT'
